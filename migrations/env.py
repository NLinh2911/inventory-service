...
def run_migrations_offline() -> None:
    ...
    """
    # url = config.get_main_option("sqlalchemy.url") #just get the config value from alembic.ini
    url = get_url()
    context.configure(
        url=url,
...
def run_migrations_online() -> None:
    ...
    # )
    #  retrieves the entire configuration section from alembic.ini and then overrides the URL
